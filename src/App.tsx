  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500 ${
        ...
        <div className="bg-black/80 backdrop-blur-xl rounded-full px-8 py-3 shadow-2xl border border-white/10">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-6">
                <button onClick={() => scrollToSection('hero')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">Home</button>
                <button onClick={() => scrollToSection('categories')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">Categories</button>
                <button onClick={() => scrollToSection('products')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">Products</button>
                <button onClick={() => scrollToSection('limited')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">Limited</button>
                <button onClick={() => scrollToSection('collabs')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">Collabs</button>
                <button onClick={() => scrollToSection('about')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">About</button>
                <button onClick={() => scrollToSection('contact')} className="text-white/80 hover:text-blue-400 transition-all duration-300 text-sm font-medium hover:scale-105">Contact</button>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4 ml-8">
              <Search 
                className="h-5 w-5 text-white/80 hover:text-blue-400 cursor-pointer transition-all duration-300 hover:scale-110" 
              ...
              <div className="relative">
                {isAuthenticated ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={logout}
                      className="text-xs bg-white/10 hover:bg-white/20 px-2 py-1 rounded transition-colors duration-300"
                    >
                      Logout
                    </button>
                  </div>
            ...
            <div className="md:hidden">
              <button
                onClick={toggleMenu}
                className="inline-flex items-center justify-center p-2 rounded-full text-white/80 hover:text-blue-400 transition-all duration-300 hover:scale-110"
              >
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 mt-2">
            <div className="bg-black/90 backdrop-blur-xl rounded-2xl mx-4 p-4 shadow-2xl border border-white/10">
              <div className="space-y-2">
                <button onClick={() => scrollToSection('hero')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">Home</button>
                <button onClick={() => scrollToSection('categories')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">Categories</button>
                <button onClick={() => scrollToSection('products')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">Products</button>
                <button onClick={() => scrollToSection('limited')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">Limited</button>
                <button onClick={() => scrollToSection('collabs')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">Collabs</button>
                <button onClick={() => scrollToSection('about')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">About</button>
                <button onClick={() => scrollToSection('contact')} className="block w-full text-left px-4 py-3 text-white/80 hover:text-blue-400 hover:bg-white/5 rounded-xl transition-all duration-300">Contact</button>
              </div>
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button 
              ...
              className="border-2 border-blue-600 text-blue-400 hover:bg-blue-600 hover:text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
            >
              Browse Categories
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {categories.slice(1).map((category) => {
              ...
              return (
                <div key={category.id} className="group cursor-pointer" onClick={() => {
                  setActiveCategory(category.id);
                  scrollToSection('products');
                }}>
                  <div className="bg-gradient-to-br from-blue-900/20 to-black/80 rounded-lg p-8 text-center transform transition-all duration-300 group-hover:scale-105 group-hover:bg-blue-600/20 border border-blue-600/20 group-hover:border-blue-400/40">
                    ...
                    <h3 className="text-lg font-semibold group-hover:text-blue-400 transition-colors duration-300">{category.name}</h3>
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="bg-blue-600/10 rounded-full p-6 w-20 h-20 flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-600/20 transition-colors duration-300">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold mb-4">Otaku Approved</h3>
      ...
      <section id="limited" className="py-20 bg-gradient-to-b from-black to-red-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            {[
              ...
              <div key={index} className="group cursor-pointer">
                <div className="bg-black rounded-lg overflow-hidden shadow-2xl transform transition-all duration-300 group-hover:scale-105 group-hover:shadow-red-500/20 border border-red-600/30 group-hover:border-red-400/50 relative">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold mb-2 group-hover:text-red-400 transition-colors duration-300">{product.name}</h3>
          ...
          <div className="text-center mt-12">
            <button 
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 mx-auto"
            >
              View More Limited Editions <ArrowRight className="h-5 w-5" />
            </button>
          </div>
        </div>
      </section>
            ...
            {filteredProducts.map((product, index) => {
              ...
              return (
                <div key={index} className="group cursor-pointer" onClick={() => handleProductSelect(product)}>
                  <div className="bg-black rounded-lg overflow-hidden shadow-2xl transform transition-all duration-300 group-hover:scale-105 group-hover:shadow-blue-500/20 border border-blue-600/20 group-hover:border-blue-400/40">
                    <div className="aspect-w-3 aspect-h-4 bg-gradient-to-br from-blue-900/20 to-black/80 h-80 flex items-center justify-center">
                      <div className="text-center">
                        <div className="bg-blue-600/10 rounded-full p-8 w-24 h-24 flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-600/20 transition-colors duration-300">
                          <CategoryIcon className="h-12 w-12 text-blue-400" />
                        </div>
                        <p className="text-gray-400 text-sm">{product.anime}</p>
                      </div>
                    </div>
                    <div className="p-6">
                      <h3 className="text-xl font-semibold mb-2 group-hover:text-blue-400 transition-colors duration-300">{product.name}</h3>
                      <div className="flex justify-between items-center">
      ...
      <section id="about" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-black/80 rounded-lg p-12 text-center border border-blue-600/20">
              <div className="bg-blue-600/10 rounded-full p-12 w-48 h-48 flex items-center justify-center mx-auto">
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Stay Updated, Fellow Otaku</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-6 py-4 rounded-lg bg-gray-900 border border-blue-600/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
            />
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
              Subscribe
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <Instagram className="h-6 w-6 text-gray-400 hover:text-blue-400 cursor-pointer transition-colors duration-300" />
                <Twitter className="h-6 w-6 text-gray-400 hover:text-blue-400 cursor-pointer transition-colors duration-300" />
                <Facebook className="h-6 w-6 text-gray-400 hover:text-blue-400 cursor-pointer transition-colors duration-300" />
              </div>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Categories</h4>
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={() => {setActiveCategory('tees'); scrollToSection('products');}} className="hover:text-blue-400 transition-colors duration-300">Tees</button></li>
                <li><button onClick={() => {setActiveCategory('hoodies'); scrollToSection('products');}} className="hover:text-blue-400 transition-colors duration-300">Hoodies</button></li>
                <li><button onClick={() => {setActiveCategory('posters'); scrollToSection('products');}} className="hover:text-blue-400 transition-colors duration-300">Posters</button></li>
                <li><button onClick={() => {setActiveCategory('mousepads'); scrollToSection('products');}} className="hover:text-blue-400 transition-colors duration-300">Mousepads</button></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Customer Service</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-blue-400 transition-colors duration-300">Shipping Info</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors duration-300">Returns</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors duration-300">Size Guide</a></li>
